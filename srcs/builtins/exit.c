...
/*   Updated: 2025/01/30 16:06:02 by cdedessu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int             builtin_exit(t_simple_cmds *cmd, t_tools *tools)
{
        ...
        // Ne pas libérer tools ici - c'est la responsabilité du main
        exit(exit_code % 256);
        return (exit_code);  // Ne sera jamais atteint à cause de exit()
}
